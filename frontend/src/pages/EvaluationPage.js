...
//
//     useEffect(() => {
//         // If we already got entries from GenerateWorkspacePage, skip API fetch
...
//         if (!workspace) return;
//
//         // ⚠️ check field name from backend: use workspace.id if that's what you return
//         fetch(`/api/workspaces/${workspace.id}/qa`)
//             .then(res => res.json())
//             .then(data => {
//                 console.log('Questions and Answers from API:', data);
//                 setQuestionsAndAnswers(data);
...
//                         <button type="button" onClick={goPrevious} disabled={currentIndex === 0} className="secondary-button">
//                             Previous
//                         </button>
//
//                         {currentIndex < questionsAndAnswers.length - 1 ? (
//                             <button type="button" onClick={goNext} disabled={!isMostImportantEvaluated} className="primary-button">
//                                 Next
//                             </button>
//                         ) : (
//                             <button type="submit" disabled={!isMostImportantEvaluated} className="primary-button">
//                                 Submit Evaluation
//                             </button>
//                         )}
//                     </div>
